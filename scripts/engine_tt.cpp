...
SCRIPTS_API chudc Change_Enemy_HUD_Color;
SCRIPTS_API chudcp Change_Enemy_HUD_Color_Player;
SCRIPTS_API chudc Change_Friendly_HUD_Color;
SCRIPTS_API chudcp Change_Friendly_HUD_Color_Player;
SCRIPTS_API chudc Change_Neutral_HUD_Color;
SCRIPTS_API chudcp Change_Neutral_HUD_Color_Player;
SCRIPTS_API egt Enable_Global_Targeting;
SCRIPTS_API egtp Enable_Global_Targeting_Player;
SCRIPTS_API gsr Get_Screen_Resolution;
SCRIPTS_API chs Create_HUD_Surface;
SCRIPTS_API fhs Find_HUD_Surface;
SCRIPTS_API hudsfc Show_HUD_Surface;
SCRIPTS_API hudsfc Hide_HUD_Surface;
SCRIPTS_API hudsfc Delete_HUD_Surface;
SCRIPTS_API gcsh Get_Client_Hardware_Identifier;
SCRIPTS_API iosc Is_Overriding_Sky_Colors;
SCRIPTS_API osc Override_Sky_Colors;
SCRIPTS_API spgui Get_Warm_Sky_Color;
SCRIPTS_API spgui Get_Cold_Sky_Color;
SCRIPTS_API spgui Get_Sun_Color;
SCRIPTS_API spgui Get_Sun_Halo_Color;
SCRIPTS_API spgui Get_Moon_Halo_Color;
SCRIPTS_API spguc Get_Starfield_Alpha;
SCRIPTS_API spgui Get_Sky_Color;
SCRIPTS_API spgui Get_Gloominess_Color;
SCRIPTS_API spsui Set_Warm_Sky_Color;
SCRIPTS_API spsui Set_Cold_Sky_Color;
SCRIPTS_API spsui Set_Sun_Color;
SCRIPTS_API spsui Set_Sun_Halo_Color;
SCRIPTS_API spsui Set_Moon_Halo_Color;
SCRIPTS_API spsuc Set_Starfield_Alpha;
SCRIPTS_API spsui Set_Sky_Color;
SCRIPTS_API spsui Set_Gloominess_Color;
